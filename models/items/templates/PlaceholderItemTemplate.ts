...
class PlaceholderItemTemplates {
  ...
  static loadItems() {
	 ...
	 */
	static getPlacedTransformTemplate(transformId: number): PlacedItemTemplate | null {
	 ...
	 */
	 static getInventoryTransformTemplate(transformId: number): InventoryItemTemplate | null {
