...
test('Should Create Plant Object From PlainObject', () => {
	const serializedPlacedItem = JSON.stringify((generatePlacedItem('apple', 'abc')).toPlainObject());
	const item = Plant.fromPlainObject(JSON.parse(serializedPlacedItem));
